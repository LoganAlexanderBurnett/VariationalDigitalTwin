...
batch_size = 512
model = GRUModel(input_size=2, hidden_size1=96, hidden_size2=16, hidden_size3=48, output_size=2).to(device)
...
plt.plot(Ypred_1, label="GRU", color='r', linestyle='dashed')
...
plt.plot(Ypred_2, label="GRU", color='r', linestyle='dashed')
plt.xlabel('Time Steps (30 seconds/step)')
...
ax.plot(Ypred_1, label="GRU", color='r', linestyle='dashed')
...
ax.plot(Ypred_2, label="GRU", color='r', linestyle='dashed')
ax.set_xlabel('Time Steps (30 seconds/step)')
