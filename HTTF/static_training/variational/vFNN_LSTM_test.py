...
model = VariationalLSTMModel(in_features=2, hidden_size1=48, hidden_size2=64, hidden_size3=32, out_features=2).to(device)
...
plot_prediction_series(
    ...
    predicted_label="Variational LSTM Mean",
